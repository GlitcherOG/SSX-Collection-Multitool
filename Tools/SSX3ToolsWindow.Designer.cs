namespace SSXMultiTool
{
    partial class SSX3ToolsWindow
    {
        ...
        private void InitializeComponent()
        {
            ...
            // MorphScaleLabel
            // 
            MorphScaleLabel.AutoSize = true;
            MorphScaleLabel.Location = new Point(782, 415);
            MorphScaleLabel.Name = "MorphScaleLabel";
            MorphScaleLabel.Size = new Size(73, 15);
            MorphScaleLabel.TabIndex = 44;
            MorphScaleLabel.Text = "Morph Scale";
            // 
            // MorphScaleNumber
            // 
            MorphScaleNumber.DecimalPlaces = 6;
            MorphScaleNumber.Increment = new decimal(new int[] { 1, 0, 0, 65536 });
            MorphScaleNumber.Location = new Point(782, 433);
            MorphScaleNumber.Minimum = new decimal(new int[] { 100, 0, 0, int.MinValue });
            ...
            FormClosing += SSX3ToolsWindow_FormClosing;
